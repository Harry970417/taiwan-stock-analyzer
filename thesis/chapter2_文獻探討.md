...
> 註：本節（及後續 Gap 2）所引用之先導階段數據取自 Research Report V1（2026）先導性研究宇宙，其樣本因資料快取覆蓋率限制排除台積電（2330）、聯電（2303）等 5 檔個股，與本論文第四至六章正式鎖定之 V1 研究樣本（16 檔，涵蓋台積電、聯電）分屬不同資料池，數字不可直接互相比較；正式實證結果詳見第五章。
